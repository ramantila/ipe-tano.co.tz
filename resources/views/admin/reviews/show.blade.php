                    ...
                    <div class="row">
                        <div class="col-md-2">
                            @if ($review->business->logo != '')
                                <img src="{{ url('images/business/' . $review->business->logo) }}" alt=""
                            ...
                            {{-- <img src="http://127.0.0.1:8000/images/business/20230605172111.png"
                                class="rounded-circle img-100 align-top mr-15"> --}}
                        </div>
                        <div class="col-md-10">
                            <div class="row">
                                <div class="col-md-4 mt-15">
                                    <h4>{{ $review->business->business_name }}</h4>
                                    @php
                                        $stars = $review->business->total_rating; // Get the integer part of the rating
                                        $half_star = $review->business->total_rating - $stars >= 0.5; // Check if there is a half star
                                    @endphp
                                    @for ($i = 1; $i <= 5; $i++)
                                        @if ($i <= $stars)
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{ url('reviews/' . $review->id . '/update') }}" method="POST"
