    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    <h5>Businesses Reviews</h5>
                    <span>List of businesses reviews</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
        ...
        <div class="card">
            <div class="card-header row">
                <div class="col col-sm-2">
                    ...
                    {{-- <a href="{{ url('roles/create') }}" class="btn btn-sm btn-rounded "
                        style="background: #B28910; color: #fff;">Add Role </a> --}}
                    {{-- @endif --}}
                </div>
                                ...
                                <td class="text-center">
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="{{ url('reviews/'. $key->id .'/show') }}"><i
                                                    class="ik ik-eye"></i> View </a>
                                            {{-- @endif --}}
                                            {{-- @if (Sentinel::hasAccess('roles.delete')) --}}
                                            <a class="dropdown-item" href="{{ url('reviews/'. $key->id .'/delete') }}"><i
                                                class="ik ik-eye"></i> Delete </a>
                                            {{-- @endif --}}
                                        </div>
                                    </div>
                                </td>
