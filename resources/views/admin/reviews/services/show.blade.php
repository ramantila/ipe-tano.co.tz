        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2">
                            @if ($review->services->logo != '')
                                <img src="{{ url('images/' . $review->services->logo) }}" alt=""
                        ...
                        <div class="col-md-10">
                            <div class="row">
                                <div class="col-md-4 mt-15">
                                    <h4>{{ $review->services->product_name }}</h4>
                                    @php
                                        $stars = $review->services->total_rating; // Get the integer part of the rating
                                        $half_star = $review->services->total_rating - $stars >= 0.5; // Check if there is a half star
                                    @endphp
                                    @for ($i = 1; $i <= 5; $i++)
                                        @if ($i <= $stars)
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ url('reviews/services/review/'.$review->id.'/update') }}" method="POST"
