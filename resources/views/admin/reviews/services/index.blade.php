        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Services Reviews</h5>
                        <span>List of services reviews</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                                            ...
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    {{-- @if (Sentinel::hasAccess('roles.edit')) --}}
                                                        ...
                                                        href="{{ url('reviews/services/review/'. $key->id ) }}"><i
                                                                class="ik ik-eye"></i> View </a>
                                                    {{-- @endif --}}
                                                    {{-- @if (Sentinel::hasAccess('roles.delete')) --}}
                                                    <a class="dropdown-item" href="{{ url('reviews/services/review/'. $key->id .'/delete') }}"><i
