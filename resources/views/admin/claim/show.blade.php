                ...
                <div class="card-body">
                    <table class="table">
                        <tbody>
                            ...
                            <tr> 
                                <th width="45%">Company Registration</th>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ url('businesses-claims/' . $business->id . '/transfer') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row" style="margin-left: 2px; margin-right:2px;">

                                    <div class="col-md-12">
                                        <input id="title" type="text" class="form-control" name="type" value="claim" >
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group" style="margin-left: 17px; margin-right: 17px;">
                                            <label for="title">Select Owner<span class="text-red">*</span></label>
                                ...
                                <div class="card-body template-demo">
                                    <a href="{{ url('businesses-claims/'.$business->id.'/verify') }}" id="next_link" class="btn btn-success">Verify documents</a>
                                    <button type="submit" class="btn  btn-outline-success">Transfer Ownership</button>
