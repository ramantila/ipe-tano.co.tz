                ...
                <div class="col-xl-4 col-lg-4 col-md-4 m-auto">
                    <div class="authentication-form mx-auto">
                        <div class="logo-centered">
                            <img height="50" src="images/ipetano-logo-primary.png" alt="Ipe Tano Logo" >
                        </div>
                        <p style="color:#000">Welcome back! </p>
                        <form action="{{ url('postLogin') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col text-left">
                                    <label class="custom-control custom-checkbox"  >
                                        ...
                                        <span class="custom-control-label"style="color:black !important" >&nbsp;<span>Remember Me</span></span>
                                    </label>
                                </div>
                            ...
                            <div class="register">
                                <a href="{{ url('register') }}" class="btn btn-custom text-center">Create Account</a>
                            </div>
