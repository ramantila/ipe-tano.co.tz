            ...
            <div class="row">
                <div class="col-lg-4 mr-auto col-sm-6 col-md-6">
                    <div class="widget footer-widget mb-5 mb-lg-0">
                        ...
                        <p class="mt-3" style="color:rgb(29, 29, 29)">Ipe Tano hosts reviews and ratings to help consumers shop with confidence and deliver rich insights.</p>
                        <ul class="list-inline footer-socials">
                            <li class="list-inline-item"><a href="#"><i class="fab fa-facebook fa-3x"></i></a></li>
                ...
                <div class="col-lg-2 col-sm-6 col-md-6 col-xl-2">
                    <div class="footer-widget mb-5 mb-lg-0">
                        <h5 class="widget-title">Ipe Tano</h5>
                ...
                <div class="col-lg-2 col-sm-6 col-md-6 col-xl-2">
                    <div class="footer-widget mb-5 mb-lg-0">
                        <h5 class="widget-title">Businesses</h5>
                        <ul class="list-unstyled footer-links">
        ...
        <div class="footer-btm">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6">
                        <div class="copyright">
                            <p style="color:rgb(29, 29, 29)">© <?php echo date("Y"); ?> Tanzania Product Review Company Limited. </p>
                        </div>
                    </div>
                    <div class="col-xl-6">
