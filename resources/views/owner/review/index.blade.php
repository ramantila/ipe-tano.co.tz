                            ...
                            <tbody>
                                @foreach ($reviews as $index => $key)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($key->status == 1)
                                                <label for="" style="color:red">Pending</label>
                                            @else
                                                <label for="" style="color:green">Processing</label>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ url('reviews-business/products/'. $key->id .'/reviews') }}"><i
                                                            class="ik ik-eye"></i> Products Reviews </a>

                                                    <a class="dropdown-item"
                                                        href="{{ url('reviews-business/services/'. $key->id .'/reviews') }}"><i
                                                            class="ik ik-eye"></i> Services Reviews </a>
                                                    {{-- @endif --}}
