            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <form action="{{ url('businesses/'.$service->id.'/service/update') }}" method="POST"  enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control html-editor h-205" rows="4" id="myTextarea" name="description" required>
                                        {{ $service->description }}
                                    </textarea>
