                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    @if ($key->letter == '' && $key->business_licence == '' && $key->company_reg == '')
                                                        <a class="dropdown-item"
                                                            href="{{ url('business/' . $key->id . '/incomplete_from/step_business') }}"><i
                                                                class="ik ik-eye"></i> Incomplete Form </a>
                                                    @endif
                                                    @if (empty($key->letter) || empty($key->business_licence) || empty($key->company_reg))
                                                    @else
                                                        <a class="dropdown-item"
                                                            href="{{ url('business/' . $key->id . '/product/view') }}"><i
                                                                class="ik ik-eye"></i> View Products </a>

                                                        <a class="dropdown-item"
                                                            href="{{ url('business/' . $key->id . '/service/view') }}"><i
                                                                class="ik ik-eye"></i> View Services </a>
                                                    @endif
                                                    <a class="dropdown-item"
                                                        href="{{ url('business/' . $key->id . '/show') }}"><i
                                                            class="ik ik-eye"></i> View Business </a>

                                                    <a class="dropdown-item"
                                                        href="{{ url('business/' . $key->id . '/edit') }}"><i
        ...
        <div class="modal fade" id="delete{{ $key->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('business/' . $key->id . '/delete') }}" method="POST">
                        @csrf
