            ...
            <div class="col-lg-4">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url('claims/view') }}">Businesses Claims</a>
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="card">
                <div class="card-header row">
                    <div class="col col-sm-2">
                        ...
                        {{-- @endif --}}
                        <a href="{{ url('claims/business') }}" class="btn btn-sm  btn-rounded"
                            style="background: #B28910; color: #fff;">Claim </a>
                    </div>
                                ...
                                @foreach ($claims as $index => $key)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            {{-- @if ($key->status == 0)
                                    <label class="badge badge-danger mb-1">Pending</label>
                                    @endif --}}
