            ...
            <div class="card">
                <div class="card-header row">
                    <div class="col col-sm-2">
                        ...
                        <a  href="{{ url('business/'. $business_id .'/product/create') }}" class="btn btn-sm  btn-rounded"
                            style="background: #B28910; color: #fff;">Add Product </a>
                        {{-- @endif --}}
                    </div>
                                            ...
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ url('business/' . $key->id . '/product/edit') }}"><i
